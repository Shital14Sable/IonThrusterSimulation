...
%     test_case_path = 'C:\Users\shita\Box\Simulation\OSU-DSPG\particleTest\LHS Sampling\Sampling_Cases\ExistingThrusters\';
    ...
    test_case_path = 'C:\Users\sables\Box\Simulation\OSU-DSPG\particleTest\LHS Sampling\Sampling_Cases\Iterations_Study\';
...
%     sim_data.lengthY = 10;
    ...
    %% Optimixzation Loop
    tStart = tic;
     thruster_test = ['Sampling_Case_' num2str(2)];
...
%      thruster_data.Gap(2) = 0.25;
    ...
    output_folder_path = 'C:\Users\sables\Box\Simulation\OSU-DSPG\particleTest\MeshStudyDataOutput\Iterations_Study\' ;
